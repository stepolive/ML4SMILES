...
class descriptors():
    ...
    def generate(self, name, treat=True, col=0):
        '''
        name = 'rdkit' # rdkit, pubchem, elem_net, elem_prop, maccskeys, descriptastorus, circular
        '''
        self.name = name
    ...
    def save(self, file_name, csv=True):
        # Save data
        # joblib.dump(self.df_final, str(file_name) + '_' + str(self.name) + '.pkl')
